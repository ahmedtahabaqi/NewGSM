...
class AddLecture extends React.Component {
                                                ...
                                                <Pane>
                                                    <Dialog
                                                        ...
                                                        onConfirm={() => {
                                                                ...
                                                                axios({ url: host + "api/course/editchapter/" + this.state.lectures[index]._id, method: "POST", data: formData, headers: headers })
                                                                    ...
                                                                    onConfirm={() => {
                                                                        ...
                                                                        axios({ url: host + "api/course/deleteVideo/" + video._id, method: "POST", headers: headers })
                                                                            ...
                                                                            .catch(function (error) {
                                                                                ...
                                                                                if (error.request.response) { toaster.danger(error.request.response); }
                                                                            });
    ...
    EditChapter(id){
        ...
        // axios({ url: host + "api/course/editchapter/" + id, method: "POST", data: formData, headers: headers })
        //     .then(response => { if (response.status === 200) { window.location.reload(); this.componentDidMount(); } })
        //     .catch(function (error) { if (error.request.response) { toaster.danger(error.request.response); } });
    }
    render() {
